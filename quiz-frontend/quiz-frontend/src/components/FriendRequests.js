                ...
                <ul className="friend-requests-list">
                    {requests.map((request) => (
                        <li key={request.id} className="request-item">
                            <span className="request-username"><a
                                href={`/profile/${request.requesterUsername}`}>{request.requesterUsername}</a></span>
                            <button onClick={() => handleAccept(request.id)} className="accept-request-button">
                                Accept
                            </button>
                            <button onClick={() => handleReject(request.id)} className="accept-request-button"
